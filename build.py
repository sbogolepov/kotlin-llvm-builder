...
bootstrap_build_config = {
    ...
    "runtimes": None,
    "build_type": "Release",
    "additional_cmake_flags": platform_common_flags() + platform_bootstrap_flags(),
}


dist_dev_build_config = {
    ...
    "runtimes": None,
    "build_type": "Release",
    "additional_cmake_flags": platform_common_flags() + final_distribution_symlinks + platform_dist_flags(),
}


dist_user_build_config = {
    "target_backends": None,
    "distribution_components": None,
    "build_targets": ["install-distribution"],
    "projects": None,
...
def construct_cmake_flags(
    ...
    if config.additional_cmake_flags:
        for arg in config.additional_cmake_flags:
...
def prepare_config(config_param):
    if config_param == 'bootstrap':
        config = bootstrap_build_config
    elif config_param == 'dev':
        config = dist_dev_build_config
    elif config_param == 'user':
        config = dist_user_build_config
    elif config_param == None:
        sys.exit('Config is not selected')
    else:
